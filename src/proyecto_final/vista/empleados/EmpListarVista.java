...
public class EmpListarVista extends javax.swing.JInternalFrame {

    public EmpListarVista() {
        initComponents();
        setSize(1280, 730);
    ...
    public void mostrarDatosEmpleado(List<Empleado> empleado) {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Sans Serif Collection", 1, 30)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(81, 89, 108));
        jLabel1.setText("LISTAR EMPLEADOS REGISTRADOS");
        ...
        txtBusqueda.setFont(new java.awt.Font("Sans Serif Collection", 0, 14)); // NOI18N
        txtBusqueda.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(81, 89, 108)));

        btnBuscar.setBackground(new java.awt.Color(204, 204, 204));
        btnBuscar.setFont(new java.awt.Font("Sans Serif Collection", 0, 14)); // NOI18N
        btnBuscar.setText("Buscar");

        btnListar.setBackground(new java.awt.Color(81, 89, 108));
        btnListar.setFont(new java.awt.Font("Sans Serif Collection", 0, 14)); // NOI18N
        ...
        tblDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cédula", "Nombres", "Apellidos", "Teléono", "Direccion", "Correo", "Tipo Personal", "Cargo"
            }
        ) {
